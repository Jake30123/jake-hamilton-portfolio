...
// and precompiles app.jsx → app.js so the browser never runs Babel.
...
// ── Compile app.jsx → app.js ──────────────────────────────────────────────────
// Plain transform (no bundling): top-level declarations stay global, exactly as
// they were under in-browser Babel. React/ReactDOM come from the CDN globals.
const jsxSrc = fs.readFileSync(path.join(ROOT, 'app.jsx'), 'utf-8');
const { code: appJs } = esbuild.transformSync(jsxSrc, {
  loader: 'jsx',
  jsx: 'transform',
  target: 'es2019',
  charset: 'utf8',
...
console.log('✓ app.js');
console.log('\nDone. Commit data.js, site-config.js and app.js with your changes.');
