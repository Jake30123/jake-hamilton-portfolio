...
<!-- specs: Max power draw -->
Raspberry Pi 5: 15 W (3 A @ 5 V)
Arduino Uno R4 Minima: 0.5 W (90 mA @ 5 V)
Three Servos: 3 W (600 mA @ 5 V)
Two 8×8 Matrix Displays: 3 W (600 mA @ 5 V)
Two 12V Drive Motors: 72 W (6 A @ 12 V)
Total 5V: 4.29 A · stepped down from 12 V
Total 12V: 2.4 A · including 12 V converter draw
<!-- /specs -->
...
![Fox-Bot wires in wire sleeve](assets/img/fox-bot/sleeve.jpg)
...
![Fox-Bot hooked up to a power supply](assets/img/fox-bot/supply.jpg)
*Hooked up to a bench supply during the battery downtime.*
