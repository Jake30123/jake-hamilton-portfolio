...
tags: [EV conversion, ATV, CAD, Mechanical]
status: null
role: "Personal build"
year: "2024"
specs:
...
![A gold-painted Kawasaki Bayou 220 ATV](assets/img/atv/pre.jpg)
...
![Me working on the stripped-down frame of an ATV](assets/img/atv/frame.jpg)
...
![The ATV frame with pink painted suspension components](assets/img/atv/pink.jpg)
...
![Samsung 8s 67Ah prismatic cell module](assets/img/atv/samsung.webp)
...
![The Fardriver controller with a basic wiring harness](assets/img/atv/far.jpg)
...
<!-- pair -->
![CAD drawing of spline adapter version 1](assets/img/atv/spv1.png)
![CAD drawing of spline adapter version 4](assets/img/atv/spv2.png)
*Spline adapter v1 (left) and spline adapter v4 (right).*
<!-- /pair -->

![The electric motor mounted inline with the driveshaft](assets/img/atv/inline2.jpg)
...
![The ATV's control panel with switches and a voltage display](assets/img/atv/controls.jpg)
