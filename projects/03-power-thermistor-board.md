...
![The previous Mk6 power board and thermistor board side-by-side](assets/img/pt/mk6.webp)
*Mk6 power board (left) and thermistor board (right).*

<!-- specs: Project Requirements -->
Compliance: Follow all FSAE rules and best practices.
Goal: Combine the power and thermistor boards into a single PCB.
Mechanical: Fit existing accumulator segment constraints.
Electrical: Maintain connector placement compatibility with the BMS motherboard.
<!-- /specs -->

<!-- specs: Project Deliverables -->
Schematic: Complete PCB schematic and layout.
Sensing: Thermistors for temperature sensing.
Voltage: Copper strips and traces for voltage monitoring.
Connectors: Three 20-pin connectors to send signals to the BMS motherboard.
Fuses: Located within 20–25mm of the copper pads.
Solder: Normally open solder points.
<!-- /specs -->
...
![Version 1 of the PCB board outline CAD drawing](assets/img/pt/ptv1.png)
...
![Version 2 of the PCB board outline with bridges for thermistors](assets/img/pt/ptv2.png)
*Board outline v2.*
...
![Version 1 of the full PCB layout](assets/img/pt/pt2.png)
*V1 board layout.*
...
![Version 2 of the full PCB layout with improved traces and silkscreen](assets/img/pt/pt3.png)
*V2 board layout.*
...
![A test setup for the BMS motherboard with power supply and resistor divider](assets/img/pt/pt4.jpg)
